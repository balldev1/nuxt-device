...
<!--    <div v-if="props.device.InternetGatewayDevice && props.device.InternetGatewayDevice.LANDevice" class="mt-5 rounded-md  bg-gray-100 shadow-sm shadow-gray-950">-->
<!--      &lt;!&ndash; ถ้ามี InternetGatewayDevice จะแสดงเนื้อหาในนี้ &ndash;&gt;-->
...
interface Hosts {
  [key: string]: Host; // Adjust this type if you have a different structure
}
